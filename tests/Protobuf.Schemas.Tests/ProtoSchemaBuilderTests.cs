...
namespace Protobuf.Schemas.Tests
{
    ...
    public class ProtoSchemaBuilderTests
    {
        ...
        public void BuildSchema_FromAssembly()
        {
            ...
            string expected = @"syntax=""proto3"";packageProtobuf.Schemas.Tests.Models;import""protobuf - net / bcl.proto"";//schemaforprotobuf-net'shandlingofcore.NETtypesenumEnumValues{//thisisacomposite/flagsenumerationNone=0;Multiple=1;Scene=2;Scan=4;Face=8;Voice=16;Iris=32;}messageClassWithEnumProperty{int32Id=1;stringName=2;EnumValuesValueEnum=12;}enumEnumValues{//thisisacomposite/flagsenumerationNone=0;Multiple=1;Scene=2;Scan=4;Face=8;Voice=16;Iris=32;}messageRoot{int32Id=1;stringName=2;}messageNotGeneric{RootData=3;}messageData{stringId=5;.bcl.DateTimeCreated=6;//thefollowingrepresentsub-types;atmost1shouldhaveavalueExtendedDataExtendedData=1000;}messageExtendedData{map<string,Object>Extended=7;Stack_DataWorkToDo=8;}messageObject{}messageProcesses{.bcl.DateTimeStartDate=11;}messageStack_Data{stringName=9;int32Priority=10;repeatedDataCollection=11;//thefollowingrepresentsub-types;atmost1shouldhaveavalueProcessesProcesses=1000;}".Replace(" ", string.Empty);
            ProtobuffSchemaRender schemaRender = new ProtobuffSchemaRender(ProtoBuf.Meta.ProtoSyntax.Proto3);
